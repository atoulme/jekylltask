...
gem_spec = nil
['ruby', 'java', nil].each do |spec_platform|
  $platform = spec_platform
  gem_spec = Gem::Specification.load(File.expand_path('jekylltask.gemspec', File.dirname(__FILE__)))
  Rake::GemPackageTask.new(gem_spec).define unless spec_platform.nil? 
end
